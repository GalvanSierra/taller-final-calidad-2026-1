...
namespace App_Clinica.Controllers
{
    public class TipoUsuarioController : Controller
    {
        ...
        public TipoUsuarioController(NotificacionClinicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoUsuario,NombreTipo")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoUsuario,NombreTipo")] TipoUsuario tipoUsuario)
        {
